module {
  ...
  hal.executable private @matmul_f16_8x6656x16384_dispatch_0 {
  ...
  util.global private mutable @matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer
  util.initializer {
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %allocator = hal.device.allocator<%device : !hal.device> : !hal.allocator
    %memory_type = hal.memory_type<"DeviceVisible|DeviceLocal"> : i32
    %buffer_usage = hal.buffer_usage<"TransferSource|TransferTarget|Transfer|DispatchStorageRead|DispatchStorageWrite|DispatchStorage"> : i32
    %c218578944 = arith.constant 218578944 : index
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%queue_affinity) type(%memory_type) usage(%buffer_usage) : !hal.buffer{%c218578944}
    util.global.store %buffer, @matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer
    util.return
  }
  util.func public @matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer = util.global.load @matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    %c262144 = arith.constant 262144 : index
    %c218103808 = arith.constant 218103808 : index
    %c218365952 = arith.constant 218365952 : index
    %c212992 = arith.constant 212992 : index
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@matmul_f16_8x6656x16384_dispatch_0::@rocm_hsaco_fb::@matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@matmul_f16_8x6656x16384_dispatch_0) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@matmul_f16_8x6656x16384_dispatch_0::@rocm_hsaco_fb::@matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c0, %c262144], 
        (%matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c262144, %c218103808], 
        (%matmul_f16_8x6656x16384_dispatch_0_rocm_hsaco_fb_matmul_f16_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f16xf16xf32_buffer : !hal.buffer)[%c218365952, %c212992]
      ]) flags("None")
