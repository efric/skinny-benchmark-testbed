func.func @matmul_f16_8x6656x8192(%arg0: tensor<8x8192xf16>, %arg1: tensor<6656x8192xf16>) -> tensor<8x6656xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf16>, tensor<6656x8192xf16>)
