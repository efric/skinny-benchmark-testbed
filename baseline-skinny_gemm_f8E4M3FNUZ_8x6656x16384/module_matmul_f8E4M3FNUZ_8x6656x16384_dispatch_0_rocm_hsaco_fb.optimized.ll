...
235:                                              ; preds = %133
  ...
  %239 = mul nuw nsw i32 %8, 26624
  %240 = add nuw nsw i32 %239, 19968
  %241 = add nuw nsw i32 %239, 13312
  %242 = add nuw nsw i32 %239, 6656
  %243 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 212992, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
