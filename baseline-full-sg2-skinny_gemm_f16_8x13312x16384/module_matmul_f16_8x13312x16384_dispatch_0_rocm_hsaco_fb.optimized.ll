...
226:                                              ; preds = %124
  ...
  %230 = mul nuw nsw i32 %9, 13312
  %231 = add nuw nsw i32 %230, 39936
  %232 = add nuw nsw i32 %230, 26624
  %233 = add nuw nsw i32 %230, 13312
  %234 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 425984, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
