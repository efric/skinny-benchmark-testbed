...
; ModuleID = 'matmul_f8E5M2FNUZ_8x13312x16384_dispatch_0'
source_filename = "matmul_f8E5M2FNUZ_8x13312x16384_dispatch_0"
...
define amdgpu_kernel void @matmul_f8E5M2FNUZ_8x13312x16384_dispatch_0_matmul_like_8x13312x16384_f8E5M2FNUZxf8E5M2FNUZxf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %1, ptr addrspace(1) inreg noalias noundef nonnull writeonly align 16 captures(none) %2) local_unnamed_addr #0 !reqd_work_group_size !2 {
...
106:                                              ; preds = %3, %106
  ...
  %143 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %141, <4 x i32> %142, <4 x float> %138, i32 %105, i32 0, i32 0)
  ...
  %148 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %146, <4 x i32> %147, <4 x float> %143, i32 %105, i32 0, i32 0)
  ...
  %158 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %141, <4 x i32> %157, <4 x float> %155, i32 %105, i32 0, i32 0)
  ...
  %161 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %146, <4 x i32> %160, <4 x float> %158, i32 %105, i32 0, i32 0)
  ...
  %170 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %168, <4 x i32> %169, <4 x float> %165, i32 %105, i32 0, i32 0)
  ...
  %175 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %173, <4 x i32> %174, <4 x float> %170, i32 %105, i32 0, i32 0)
  ...
  %182 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %168, <4 x i32> %181, <4 x float> %179, i32 %105, i32 0, i32 0)
  ...
  %185 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %173, <4 x i32> %184, <4 x float> %182, i32 %105, i32 0, i32 0)
...
201:                                              ; preds = %106
  %202 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 425984, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
  ...
  %214 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %212, <4 x i32> %213, <4 x float> %209, i32 %105, i32 0, i32 0)
  ...
  %219 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %217, <4 x i32> %218, <4 x float> %214, i32 %105, i32 0, i32 0)
  ...
  %226 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %212, <4 x i32> %225, <4 x float> %223, i32 %105, i32 0, i32 0)
  ...
  %229 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %217, <4 x i32> %228, <4 x float> %226, i32 %105, i32 0, i32 0)
  ...
  %238 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %236, <4 x i32> %237, <4 x float> %233, i32 %105, i32 0, i32 0)
  ...
  %243 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %241, <4 x i32> %242, <4 x float> %238, i32 %105, i32 0, i32 0)
  ...
  %250 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %236, <4 x i32> %249, <4 x float> %247, i32 %105, i32 0, i32 0)
  ...
  %253 = tail call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %241, <4 x i32> %252, <4 x float> %250, i32 %105, i32 0, i32 0)
  ...
  %266 = getelementptr i8, ptr addrspace(7) %262, i32 53248
...
declare <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32>, <4 x i32>, <4 x float>, i32, i32 immarg, i32 immarg) #6
