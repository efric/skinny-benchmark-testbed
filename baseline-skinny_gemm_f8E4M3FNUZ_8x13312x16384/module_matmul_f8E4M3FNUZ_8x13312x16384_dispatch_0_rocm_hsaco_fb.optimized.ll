...
define amdgpu_kernel void @matmul_f8E4M3FNUZ_8x13312x16384_dispatch_0_matmul_like_8x13312x16384_f8E4M3FNUZxf8E4M3FNUZxf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %1, ptr addrspace(1) inreg noalias noundef nonnull align 16 %2) local_unnamed_addr #0 !reqd_work_group_size !2 {
  ...
  %19 = and i32 %18, 240
  %20 = tail call range(i32 0, 208) i32 @llvm.amdgcn.workgroup.id.x()
...
133:                                              ; preds = %3, %133
  ...
  %190 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %157, i64 %165, <4 x float> %189, i32 0, i32 0, i32 0)
  ...
  %200 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %157, i64 %173, <4 x float> %199, i32 0, i32 0, i32 0)
  %201 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %158, i64 %166, <4 x float> %190, i32 0, i32 0, i32 0)
  %202 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %158, i64 %174, <4 x float> %200, i32 0, i32 0, i32 0)
  %203 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %159, i64 %167, <4 x float> %201, i32 0, i32 0, i32 0)
  %204 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %159, i64 %175, <4 x float> %202, i32 0, i32 0, i32 0)
  %205 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %160, i64 %168, <4 x float> %203, i32 0, i32 0, i32 0)
  %206 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %160, i64 %176, <4 x float> %204, i32 0, i32 0, i32 0)
  %207 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %161, i64 %169, <4 x float> %205, i32 0, i32 0, i32 0)
  %208 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %161, i64 %177, <4 x float> %206, i32 0, i32 0, i32 0)
  %209 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %162, i64 %170, <4 x float> %207, i32 0, i32 0, i32 0)
  %210 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %162, i64 %178, <4 x float> %208, i32 0, i32 0, i32 0)
  %211 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %163, i64 %171, <4 x float> %209, i32 0, i32 0, i32 0)
  %212 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %163, i64 %179, <4 x float> %210, i32 0, i32 0, i32 0)
  %213 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %164, i64 %172, <4 x float> %211, i32 0, i32 0, i32 0)
  %214 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %164, i64 %180, <4 x float> %212, i32 0, i32 0, i32 0)
...
235:                                              ; preds = %133
  ...
  %239 = mul nuw nsw i32 %8, 53248
  %240 = add nuw nsw i32 %239, 39936
  %241 = add nuw nsw i32 %239, 26624
  %242 = add nuw nsw i32 %239, 13312
  %243 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 425984, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
  ...
  %268 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %244, i64 %252, <4 x float> %213, i32 0, i32 0, i32 0)
  %269 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %244, i64 %260, <4 x float> %214, i32 0, i32 0, i32 0)
  %270 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %245, i64 %253, <4 x float> %268, i32 0, i32 0, i32 0)
  %271 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %245, i64 %261, <4 x float> %269, i32 0, i32 0, i32 0)
  %272 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %246, i64 %254, <4 x float> %270, i32 0, i32 0, i32 0)
  %273 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %246, i64 %262, <4 x float> %271, i32 0, i32 0, i32 0)
  %274 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %247, i64 %255, <4 x float> %272, i32 0, i32 0, i32 0)
  %275 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %247, i64 %263, <4 x float> %273, i32 0, i32 0, i32 0)
  %276 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %248, i64 %256, <4 x float> %274, i32 0, i32 0, i32 0)
  %277 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %248, i64 %264, <4 x float> %275, i32 0, i32 0, i32 0)
  %278 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %249, i64 %257, <4 x float> %276, i32 0, i32 0, i32 0)
  %279 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %249, i64 %265, <4 x float> %277, i32 0, i32 0, i32 0)
  %280 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %250, i64 %258, <4 x float> %278, i32 0, i32 0, i32 0)
  %281 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %250, i64 %266, <4 x float> %279, i32 0, i32 0, i32 0)
  %282 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %251, i64 %259, <4 x float> %280, i32 0, i32 0, i32 0)
  %283 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.fp8.fp8(i64 %251, i64 %267, <4 x float> %281, i32 0, i32 0, i32 0)
