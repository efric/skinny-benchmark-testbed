func.func @matmul_f16_8x2304x8192(%arg0: tensor<8x8192xf16>, %arg1: tensor<2304x8192xf16>) -> tensor<8x2304xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf16>, tensor<2304x8192xf16>)
