func.func @matmul_f8E5M2FNUZ_8x2304x8192(%arg0: tensor<8x8192xf8E5M2FNUZ>, %arg1: tensor<2304x8192xf8E5M2FNUZ>) -> tensor<8x2304xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf8E5M2FNUZ>, tensor<2304x8192xf8E5M2FNUZ>)
