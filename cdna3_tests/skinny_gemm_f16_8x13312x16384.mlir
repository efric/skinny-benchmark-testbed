func.func @matmul_f16_8x13312x16384(%arg0: tensor<8x16384xf16>, %arg1: tensor<13312x16384xf16>) -> tensor<8x13312xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x16384xf16>, tensor<13312x16384xf16>)
