func.func @matmul_f16_8x6656x16384(%arg0: tensor<8x16384xf16>, %arg1: tensor<6656x16384xf16>) -> tensor<8x6656xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x16384xf16>, tensor<6656x16384xf16>)
