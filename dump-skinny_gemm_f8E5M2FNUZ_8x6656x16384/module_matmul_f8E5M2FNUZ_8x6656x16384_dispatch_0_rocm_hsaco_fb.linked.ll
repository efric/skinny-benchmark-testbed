...
175:                                              ; preds = %171
  ...
  %266 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %263, <4 x i32> %264, <4 x float> %260, i32 %265, i32 0, i32 0)
  ...
  %272 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %269, <4 x i32> %270, <4 x float> %266, i32 %271, i32 0, i32 0)
  ...
  %287 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %284, <4 x i32> %285, <4 x float> %282, i32 %286, i32 0, i32 0)
  ...
  %292 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %289, <4 x i32> %290, <4 x float> %287, i32 %291, i32 0, i32 0)
  ...
  %302 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %299, <4 x i32> %300, <4 x float> %296, i32 %301, i32 0, i32 0)
  ...
  %308 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %305, <4 x i32> %306, <4 x float> %302, i32 %307, i32 0, i32 0)
  ...
  %317 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %314, <4 x i32> %315, <4 x float> %312, i32 %316, i32 0, i32 0)
  ...
  %322 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %319, <4 x i32> %320, <4 x float> %317, i32 %321, i32 0, i32 0)
...
368:                                              ; preds = %171
  ...
  %405 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %402, <4 x i32> %403, <4 x float> %399, i32 %404, i32 0, i32 0)
  ...
  %411 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %408, <4 x i32> %409, <4 x float> %405, i32 %410, i32 0, i32 0)
  ...
  %426 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %423, <4 x i32> %424, <4 x float> %421, i32 %425, i32 0, i32 0)
  ...
  %431 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %428, <4 x i32> %429, <4 x float> %426, i32 %430, i32 0, i32 0)
  ...
  %441 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %438, <4 x i32> %439, <4 x float> %435, i32 %440, i32 0, i32 0)
  ...
  %447 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %444, <4 x i32> %445, <4 x float> %441, i32 %446, i32 0, i32 0)
  ...
  %456 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %453, <4 x i32> %454, <4 x float> %451, i32 %455, i32 0, i32 0)
  ...
  %461 = call <4 x float> @llvm.amdgcn.smfmac.f32.16x16x64.bf8.bf8(<2 x i32> %458, <4 x i32> %459, <4 x float> %456, i32 %460, i32 0, i32 0)
