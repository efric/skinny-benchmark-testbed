...
define amdgpu_kernel void @matmul_f8E5M2FNUZ_8x6656x16384_dispatch_0_matmul_like_8x6656x16384_f8E5M2FNUZxf8E5M2FNUZxf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %1, ptr addrspace(1) inreg noalias noundef nonnull writeonly align 16 captures(none) %2) local_unnamed_addr #0 !reqd_work_group_size !2 {
