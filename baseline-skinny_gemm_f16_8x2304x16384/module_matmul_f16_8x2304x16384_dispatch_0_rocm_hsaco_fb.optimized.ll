...
define amdgpu_kernel void @matmul_f16_8x2304x16384_dispatch_0_matmul_like_8x2304x16384_f16xf16xf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %1, ptr addrspace(1) inreg noalias noundef nonnull align 16 %2) local_unnamed_addr #0 !reqd_work_group_size !2 {
...
226:                                              ; preds = %124
  ...
  %230 = mul nuw nsw i32 %9, 2304
  %231 = add nuw nsw i32 %230, 6912
  %232 = add nuw nsw i32 %230, 4608
  %233 = add nuw nsw i32 %230, 2304
  %234 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 73728, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
