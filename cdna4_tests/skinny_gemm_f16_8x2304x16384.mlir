func.func @matmul_f16_8x2304x16384(%arg0: tensor<8x16384xf16>, %arg1: tensor<2304x16384xf16>) -> tensor<8x2304xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x16384xf16>, tensor<2304x16384xf16>)
