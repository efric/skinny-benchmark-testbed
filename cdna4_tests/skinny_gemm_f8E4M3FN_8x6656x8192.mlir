func.func @matmul_f8E4M3FN_8x6656x8192(%arg0: tensor<8x8192xf8E4M3FN>, %arg1: tensor<6656x8192xf8E4M3FN>) -> tensor<8x6656xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf8E4M3FN>, tensor<6656x8192xf8E4M3FN>)
