func.func @matmul_f16_8x13312x8192(%arg0: tensor<8x8192xf16>, %arg1: tensor<13312x8192xf16>) -> tensor<8x13312xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf16>, tensor<13312x8192xf16>)
