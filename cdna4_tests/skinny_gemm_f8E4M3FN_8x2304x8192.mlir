func.func @matmul_f8E4M3FN_8x2304x8192(%arg0: tensor<8x8192xf8E4M3FN>, %arg1: tensor<2304x8192xf8E4M3FN>) -> tensor<8x2304xf32> {
  ...
  } ins(%arg0, %arg1 : tensor<8x8192xf8E4M3FN>, tensor<2304x8192xf8E4M3FN>)
