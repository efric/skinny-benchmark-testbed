...
define amdgpu_kernel void @matmul_f8E5M2FNUZ_8x2304x16384_dispatch_0_matmul_like_8x2304x16384_f8E5M2FNUZxf8E5M2FNUZxf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 %1, ptr addrspace(1) inreg noalias noundef nonnull align 16 %2) #0 !reqd_work_group_size !2 {
  ...
  %7 = call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) %1, i16 0, i64 37748736, i32 159744)
  ...
  %78 = call range(i32 0, 36) i32 @llvm.amdgcn.workgroup.id.x()
