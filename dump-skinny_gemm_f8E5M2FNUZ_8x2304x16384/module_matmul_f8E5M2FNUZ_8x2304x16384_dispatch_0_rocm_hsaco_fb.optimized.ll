...
define amdgpu_kernel void @matmul_f8E5M2FNUZ_8x2304x16384_dispatch_0_matmul_like_8x2304x16384_f8E5M2FNUZxf8E5M2FNUZxf32(ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %0, ptr addrspace(1) inreg noalias noundef nonnull readonly align 16 captures(none) %1, ptr addrspace(1) inreg noalias noundef nonnull writeonly align 16 captures(none) %2) local_unnamed_addr #0 !reqd_work_group_size !2 {
  ...
  %26 = and i32 %12, 240
  %27 = tail call range(i32 0, 36) i32 @llvm.amdgcn.workgroup.id.x()
...
201:                                              ; preds = %106
  %202 = tail call ptr addrspace(7) @llvm.amdgcn.make.buffer.rsrc.p7.p1(ptr addrspace(1) nonnull %2, i16 0, i64 73728, i32 159744)
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
  ...
  %266 = getelementptr i8, ptr addrspace(7) %262, i32 9216
